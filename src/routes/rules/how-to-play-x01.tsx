...
export const Route = createFileRoute("/rules/how-to-play-x01")({
  ...
  head: () => ({
    meta: [
      ...
      },
      {
        name: "description",
        content:
          "Guide on how to play X01, the internationally popular darts game. The goal is to be the first player to reach 0 points, but don't go over! ",
      },
    ],
  }),
});
