...
export const Route = createFileRoute('/rules/how-to-play-killer')({
  component: RouteComponent,
    ...
    meta: [
      ...
      {
        name: "description",
        content: "Killer Darts Playing Guide and scorekeeper. Gain lives to reach killer status, and then eliminate your opponents and be the last one standing!"
      },
    ],
  }),
})
